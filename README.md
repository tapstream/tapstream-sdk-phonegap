...
If you're using Adobe PhoneGap Build, add the following to your `config.xml` to use version 1.0.0 of this plugin (recommended):

```xml
<gap:plugin name="com.tapstream.phonegap" version="1.0.0" />
```
